...
namespace CA_RS11_P2_1_WEBCORE_CharlesPrado.Controllers
{
    public class CityController : Controller
    {
        ...
        public CityController(RSGYMDBContext_Connect context)
        {
            _context = context;
        }
        ...
        {
            var rSGYMDBContext_Connect = _context.City.Include(c => c.Country);
        ...
        public async Task<IActionResult> Create([Bind("CityId,Name,CountryId")] City city)
        {
            ...
            ViewData["CountryId"] = new SelectList(_context.Country, "CountryId", "CountryName", city.CountryId);
            return View(city);
        }
